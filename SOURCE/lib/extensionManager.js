...
ExtensionManager.prototype.callServiceAugmentation = function () {
    ...
    var items = ["tv", "phone", "tech", "electrical", "house", "health", "beauty", "child", "sport", "freetime"];
    ...
    var baseUrl = "http://freead60d-freeapp.eu.webratio.net/page1/";

    var urlToCall = cors + baseUrl + item;
